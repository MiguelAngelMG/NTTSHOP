<%@ Page Language="C#" MasterPageFile="MasterPage.master"  AutoEventWireup="true" Title="MasterPage Example" CodeBehind="PageLanguage.aspx.cs" Inherits="NTT_Shop.WebForms.PageLanguage" %>
		        ...
		        <article>
			        ...
			        <div class="content">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField >
                                <ItemTemplate>
                                    <asp:Label ID="lbDescription" Text='<%# Eval("descripcion")%>' runat="server" />
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox id="txtDescription" MaxLength="65"  runat="server" CssClass="CELDA7 width98" Text='<%# Eval("descripcion")%>' autocomplete="off"></asp:TextBox> 
                                </EditItemTemplate>
